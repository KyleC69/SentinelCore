---
name: ProjectTerminology.instructions.md
description: Defines a core set of terms used in documentation and agent interactions to describe specific components in this repo
applyTo: '**'
