...
public sealed class MicrosoftDocsSearchTool : AITool
{
    ...
    public MicrosoftDocsSearchTool(string endpoint) => _endpoint = endpoint;
    ...
    public async Task<object?> microsoft_docs_search([Description("query (string): The search query for retrieval")] string? input)
    {
        ...
        HttpResponseMessage response = await client.PostAsync(_endpoint, JsonContent.Create(payload));
...
public sealed class MicrosoftDocsFetchTool : AITool
{
    ...
    public MicrosoftDocsFetchTool(string endpoint) => _endpoint = endpoint;
...
public sealed class MicrosoftCodeSampleSearchTool : AITool
{
    ...
    public MicrosoftCodeSampleSearchTool(string endpoint) => _endpoint = endpoint;
