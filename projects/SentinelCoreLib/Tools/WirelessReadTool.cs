...
public sealed class WirelessReadTool : AITool
{
    ...
    public Task<ToolResult> wireless_list_interfaces()
    {
        ...
        {
            return Task.FromResult(ToolResult.FailureResult($"Wireless interface listing failed: {ex.Message}"));
        }
    }
    ...
    public Task<ToolResult> wireless_list_profiles()
    {
        ...
        {
            return Task.FromResult(ToolResult.FailureResult($"Wireless profile listing failed: {ex.Message}"));
        }
    }
}