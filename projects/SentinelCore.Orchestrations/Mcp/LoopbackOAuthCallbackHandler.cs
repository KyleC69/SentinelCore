...
public static class LoopbackOAuthCallbackHandler
{
    ...
    public static Func<AuthorizationCallbackContext, CancellationToken, Task<AuthorizationResult?>> Create(Uri? preferredCallbackUri = null)
    {
        return async (context, cancellationToken) =>
        {
            ...
            try
            {
                ...
                HttpListenerContext httpContext = await listener
                    .GetContextAsync()
    ...
    {
        string body = success
            ? "<html><body><p>Authorization succeeded. You may close this window.</p></body></html>"
            : "<html><body><p>Authorization failed. Please return to SentinelCore.</p></body></html>";
